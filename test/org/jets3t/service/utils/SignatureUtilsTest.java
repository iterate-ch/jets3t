...
public class SignatureUtilsTest {
    ...
    @Test
    public void testAwsV4BuildCanonicalRequestStringAmpersandInPefix() throws Exception {
    ...
    @Test
    public void testAwsV4BuildCanonicalRequestStringEqualSignInPrefix() throws Exception {
        final URI uri = new URI("" +
                "https://test-eu-central-1-mountainduck.s3-eu-central-1.amazonaws.com:443/?max-keys=1000&prefix=%3D%2F&delimiter=%2F");
        final String method = "GET";
        final Map<String, String> headers = new HashMap<String, String>();
        headers.put("date", "Mon, 18 Jan 2016 15:41:49 GMT");
        headers.put("x-amz-content-sha256", "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
        ...
        assertEquals("GET\n" +
                        "/\n" +
                        "delimiter=%2F&max-keys=1000&prefix=%3D%2F\n" +
                        "date:Mon, 18 Jan 2016 15:41:49 GMT\n" +
                        "host:test-eu-central-1-mountainduck.s3.amazonaws.com\n" +
                        "x-amz-content-sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855\n" +
                        "x-amz-date:20160118T154149Z\n" +
